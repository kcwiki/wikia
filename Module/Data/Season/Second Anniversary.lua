...
return {
  index = {
    ["Destroyers"] = { "Mutsuki", "Kisaragi", "Yayoi", "Uzuki", "Satsuki", "Fumizuki", "Nagatsuki", "Kikuzuki", "Mikazuki", "Mochizuki", "Fubuki", "Shirayuki", "Hatsuyuki", "Miyuki", "Murakumo", "Ayanami", "Shikinami", "Hatsuharu", "Nenohi", "Hatsushimo", "Shiratsuyu", "Shigure", "Murasame", "Yuudachi", "Samidare", "Suzukaze", "Yamagumo", "Asagumo", "Kagerou", "Shiranui", "Kuroshio", "Hatsukaze", "Yukikaze", "Tokitsukaze", "Hamakaze", "Nowaki", "Maikaze", "Asashimo", "Akizuki" },
    ["Light Cruisers"] = { "Ooi", "Kitakami", "Yura", "Kinu", "Abukuma", "Yuubari" },
    ["Heavy Cruisers"] = { "Furutaka", "Kako", "Myoukou", "Nachi", "Ashigara", "Haguro", "Maya", "Choukai", "Suzuya", "Kumano", "Prinz Eugen" },
    ["Battleships"] = { "Kongou", "Hiei", "Haruna", "Kirishima", "Fusou", "Yamashiro", "Ise", "Hyuuga" },
    ["Light Carriers"] = { "Ryuujou", "Hiyou", "Junyou", "Shouhou", "Zuihou" },
    ["Standard Carriers"] = { "Akagi", "Souryuu", "Hiryuu", "Shoukaku", "Zuikaku", "Amagi" },
    ["Submarines"] = { "U-511", "Ro-500" },
    ["Auxiliaries"] = { "Katori", "Akashi" },
  },
  ships = {
    ["Mutsuki"] = {
      {
    ...
    ["Miyuki"] = {
      {
        ja = "おおそうか！今日は特別な日じゃん！司令官、これからもよろしくな！",
    ...
    ["Nenohi"] = {
      {
        ja = "今日は何の日？そう、子の日、じゃないけど、特別の日。やったね。",
    ...
    ["Ro-500"] = {
      {
        ja = "提督、やったね。今日はお祭りだね。ろーちゃんも、嬉しいって！はい！",
        en = "Admiral, you did it! Today is a festival, right? Ro, too, is happy! Yup!",
      },
    },
    ["Katori"] = {
      {
